...
Here is an example of how to enable the Rules module by using the update hook in the curve_demo_controller.install file:

/**
 * Enabling Rules module
 */
function curve_demo_controller_update_7000()
{
  $modules = array('rules');
